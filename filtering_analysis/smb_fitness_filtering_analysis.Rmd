...
full_data <- merge(full_genotype_data, 
                   full_phenotype_data,
                   by = c("sample_id","river_code","sample_number","easting","northing","range_id","river","population"))
```

#### 5b. Create new column in full data to categorize samples by their size bin (25 mm size intervals); run the Rmd chunk below.
As part of the experimental design of this study, we aimed to collect approximately 10 fish per 25 mm size cohort, starting with 200 mm total length when alive (tl_alive = 200-224.9mm, 225-249.9mm, etc.) in order to run models for individual growth rate and maximum total length (see Analysis 3).
