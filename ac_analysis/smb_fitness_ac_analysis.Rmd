...
condition_data <- condition_data %>%
  mutate(condition_adj = 1000*(mass_dead/(tl_alive^3)))

ggplot(condition_data, aes(x = smb, y = condition, color = sex)) +
  geom_point(position = position_jitter()) +
  geom_smooth(method = "lm")


mod <- lm(condition_adj ~ smb + smb*river, data = condition_data)
