...
smb <- seq(-6, 6, 0.1) # We opted to extend these values beyond the min and max of the scaled values to make sure we encompassed predicted condition values for smb ancestry values of 1 and 0.
