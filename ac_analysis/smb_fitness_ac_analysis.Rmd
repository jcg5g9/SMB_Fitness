...
### STEP 1: Load and prepare data for analysis; run the Rmd chunk below.
In this step, we use a Bayesian hierarchical framework and fit a generalized linear model of the form: condition ~ smb + river + sex. We

```{r}
fit <- stan(
  file = "code/condition_model_2.stan",  
  data = data,    
  chains = 4,             
  warmup = 2000,          
  iter = 4000,            
