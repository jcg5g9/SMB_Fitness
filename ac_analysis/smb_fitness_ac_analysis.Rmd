...
# Get sequence of smb values to predict from, and increase by 0.1
smb <- seq(-1.3, 2.2, 0.1)
...
pdf("figures/ac_predict.pdf", width = 7, height = 5)
...
ggplot() + 
  ...
  xlim(0,1) +
  scale_x_continuous(name = "Proportion of SMB ancestry (%)", expand = c(0,0), labels = number_format(accuracy = 0.001)) +
