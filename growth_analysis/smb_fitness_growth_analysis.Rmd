...
In this step, we summarize the full back-calculated dataset, which includes back-calculated length-at-annulus datapoins for all annuli for each fish in the dataset. 
...
##### Plot mean back-calculated total length for the global datset: `figures/vb_plots/global_ave.pdf`
```{r}
# Load full bc data
load("data/bc_data/full_bc_data.Rda")
...
pdf("figures/global_ave.pdf", width = 6, height = 4)
...
##### Plot mean back-calculated total length for rivers: `figures/vb_plots/river_ave.pdf`
```{r}
# Load full bc data
load("data/bc_data/full_bc_data.Rda")
...
pdf("figures/river_ave.pdf", width = 6, height = 4)
...
##### Plot mean back-calculated total length for sex: `figures/vb_plots/sex_ave.pdf`
```{r}
# Load full bc data
load("data/bc_data/full_bc_data.Rda")
...
pdf("figures/sex_ave.pdf", width = 6, height = 4)
...
##### Plot mean back-calculated total length for ancestry groups: `figures/vb_plots/ancestry_ave.pdf`
```{r}
# Load full bc data
load("data/bc_data/full_bc_data.Rda")
...
pdf("figures/ancestry_ave.pdf", width = 6, height = 4)
