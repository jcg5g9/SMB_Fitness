...
bc_data = list(Nobs = length(length),
               Nages = 15,
               length = length,
               age = age,
               Zero = rep(0, 3),
...
saveRDS(bc_fit, file = "growth_analysis/bc_fit.rds")
