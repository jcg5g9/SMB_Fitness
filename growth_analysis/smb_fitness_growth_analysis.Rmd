...
full_bc_data$residuals <- resid(global)

ggplot(full_bc_data, aes(x = tl_alive)) +
  geom_histogram()


ggplot(full_bc_data, aes(x = annulus, y = residuals)) +
...
Linf <- ggplot(global_boot_data, aes(x = Linf, fill = "grey")) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
...
K <- ggplot(global_boot_data, aes(x = K, fill = "grey")) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
...
t0 <- ggplot(global_boot_data, aes(x = t0, fill = "grey")) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
...
# Plot histogram of Linf bootstrap values
Linf <- ggplot(river_boot_data, aes(x = Linf, fill = river)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
  geom_segment(aes(x = 391.2426135, xend = 490.53084606, y = 2100, yend = 2100), color = "grey80", stat = "identity") +
  geom_segment(aes(x = 417.9443640, xend = 556.15003690, y = 1600, yend = 1600), color = "grey20", stat = "identity") +
  geom_point(aes(x = 430.14416, y = 2100, fill = "grey80"), color = "black", pch = 21, size = 4, show.legend = F) +
  geom_point(aes(x = 464.18395, y = 1600, fill = "grey20"), color = "black", pch = 21, size = 4, show.legend = F) +
  theme_set(theme_cowplot(12)) +
  labs(x = "L∞", y = "Frequency") +
  scale_fill_manual(values = c("grey20","grey80", "grey20", "grey80")) +
  theme(axis.title = element_text(size = 15)) + 
  theme(axis.text = element_text(size = 15)) +
  theme(panel.border = element_rect(colour = "black", fill = NA, size = 1)) +
  theme(plot.margin = margin(10,10,10,10)) +
...
# Plot histogram of K bootstrap values
K <- ggplot(river_boot_data, aes(x = K, fill = river)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
...
# Plot histogram of t<sub>0</sub> bootstrap values
t0 <- ggplot(river_boot_data, aes(x = t0, fill = river)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
...
# Plot histogram of Linf bootstrap values
Linf <- ggplot(sex_boot_data, aes(x = Linf, fill = sex)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
  geom_segment(aes(x = 407.1501469, xend = 511.68671810, y = 2300, yend = 2300), color = "grey20", stat = "identity") +
  geom_segment(aes(x = 396.3111777, xend = 515.08685844, y = 2050, yend = 2050), color = "grey80", stat = "identity") +
  geom_point(aes(x = 445.56110, y = 2300, fill = "grey20"), color = "black", pch = 21, size = 4, show.legend = F) +
  geom_point(aes(x = 440.35229, y = 2050, fill = "grey80"), color = "black", pch = 21, size = 4, show.legend = F) +
  theme_set(theme_cowplot(12)) +
  labs(x = "L∞", y = "Frequency") +
  scale_fill_manual(values = c("grey80","grey20","grey80","grey20")) +
  theme(axis.title = element_text(size = 15)) + 
  theme(axis.text = element_text(size = 15)) +
  theme(panel.border = element_rect(colour = "black", fill = NA, size = 1)) +
  theme(plot.margin = margin(10,10,10,10)) +
...
# Plot histogram of K bootstrap values
K <- ggplot(sex_boot_data, aes(x = K, fill = sex)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
  geom_segment(aes(x = 0.2137145, xend = 0.37185320, y = 1200, yend = 1200), color = "grey20", stat = "identity") +
  geom_segment(aes(x = 0.1967684, xend = 0.35531175, y = 1100,  yend = 1100), color = "grey80", stat = "identity") +
  geom_point(aes(x = 0.28940, y = 1200, fill = "grey20"), color = "black", pch = 21, size = 4, show.legend = F) +
  geom_point(aes(x = 0.27610, y = 1100, fill = "grey80"), color = "black", pch = 21, size = 4, show.legend = F) +
  theme_set(theme_cowplot(12)) +
  labs(x = "K", y = "Frequency") +
  scale_fill_manual(values = c("grey80","grey20","grey80","grey20")) +
  theme(axis.title = element_text(size = 15)) + 
...
# Plot histogram of t<sub>0</sub> bootstrap values
t0 <- ggplot(sex_boot_data, aes(x = t0, fill = sex)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
  geom_segment(aes(x = -0.5874782, xend = -0.06788280, y = 1300, yend = 1300), color = "grey20", stat = "identity") +
  geom_segment(aes(x = -0.6221602, xend = -0.09637011, y = 1200, yend = 1200), color = "grey80", stat = "identity") +
  geom_point(aes(x = -0.28420, y = 1300, fill = "grey20"), color = "black", pch = 21, size = 4, show.legend = F) +
  geom_point(aes(x = -0.31403, y = 1200, fill = "grey80"), color = "black", pch = 21, size = 4, show.legend = F) +
  theme_set(theme_cowplot(12)) +
  labs(x = "t0", y = "Frequency") +
  scale_fill_manual(values = c("grey80","grey20","grey80","grey20")) +
  theme(axis.title = element_text(size = 15)) + 
...
# Plot histogram of Linf bootstrap values
Linf <- ggplot(ancestry_boot_data, aes(x = Linf, fill = ancestry)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
  geom_segment(aes(x = 407.1501469, xend = 511.68671810, y = 2300, yend = 2300), color = "deepskyblue", stat = "identity") +
  geom_segment(aes(x = 396.3111777, xend = 515.08685844, y = 2050, yend = 2050), color = "mediumpurple", stat = "identity") +
  geom_segment(aes(x = 396.3111777, xend = 515.08685844, y = 2050, yend = 2050), color = "deeppink2", stat = "identity") +
  geom_point(aes(x = 445.56110, y = 2300, fill = "deepskyblue"), color = "black", pch = 21, size = 4, show.legend = F) +
  geom_point(aes(x = 440.35229, y = 2050, fill = "mediumpurple"), color = "black", pch = 21, size = 4, show.legend = F) +
  geom_point(aes(x = 440.35229, y = 2050, fill = "deeppink2"), color = "black", pch = 21, size = 4, show.legend = F) +
  theme_set(theme_cowplot(12)) +
  labs(x = "L∞", y = "Frequency") +
  scale_fill_manual(values = c("deepskyblue","mediumpurple","deeppink2","deepskyblue","mediumpurple","deeppink2")) +
  theme(axis.title = element_text(size = 15)) + 
  theme(axis.text = element_text(size = 15)) +
  theme(panel.border = element_rect(colour = "black", fill = NA, size = 1)) +
  theme(plot.margin = margin(10,10,10,10)) +
...
# Plot histogram of K bootstrap values
K <- ggplot(ancestry_boot_data, aes(x = K, fill = ancestry)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
  geom_segment(aes(x = 407.1501469, xend = 511.68671810, y = 2300, yend = 2300), color = "deepskyblue", stat = "identity") +
  geom_segment(aes(x = 396.3111777, xend = 515.08685844, y = 2050, yend = 2050), color = "mediumpurple", stat = "identity") +
  geom_segment(aes(x = 396.3111777, xend = 515.08685844, y = 2050, yend = 2050), color = "deeppink2", stat = "identity") +
...
# Plot histogram of t<sub>0</sub> bootstrap values
t0 <- ggplot(ancestry_boot_data, aes(x = t0, fill = ancestry)) + 
  geom_histogram(color = "black", alpha = 0.8, position = "identity", show.legend = F) +
  geom_segment(aes(x = 407.1501469, xend = 511.68671810, y = 2300, yend = 2300), color = "deepskyblue", stat = "identity") +
  geom_segment(aes(x = 396.3111777, xend = 515.08685844, y = 2050, yend = 2050), color = "mediumpurple", stat = "identity") +
  geom_segment(aes(x = 396.3111777, xend = 515.08685844, y = 2050, yend = 2050), color = "deeppink2", stat = "identity") +
...
# Plot von Bertalanffy model
pdf("figures/ancestry.pdf", width = 6, height = 4)
...
#### EXPERIMENTING WITH OTHER DATA ANALYSES

```{r}
load("data/bc_data/full_bc_data.Rda")

full_bc_data_nb_adm <- full_bc_data %>%
  filter(ancestry_group != "Smallmouth_Bass")

full_bc_data$ancestry_mod <- with(full_bc_data, ifelse(ancestry_group=="Smallmouth_Bass", "Admixed",
                                             ifelse(ancestry_group=="Admixed", "Admixed",
                                                    ifelse(ancestry_group=="Neosho_Bass", "Neosho_Bass", "done"))))

full_bc_data_nb_adm <- full_bc_data_nb_adm %>%
  mutate(ancestry_group = factor(ancestry_group))

com <- bc_tl ~ Linf*(1-exp(-K*(annulus-t0)))
com_starts <- vbStarts(bc_tl ~ annulus, data = full_bc_data_nb_adm)
fit_com <- nls(com,
               data = full_bc_data_nb_adm,
               start = com_starts)

gen <- bc_tl ~ Linf[ancestry_group]*(1-exp(-K[ancestry_group]*(annulus-t0[ancestry_group])))
gen_starts <- lapply(com_starts, rep, 2)
fit_gen <- nls(gen,
               data = full_bc_data_nb_adm,
               start = gen_starts)

L_com <- bc_tl ~ Linf*(1-exp(-K[ancestry_group]*(annulus-t0[ancestry_group])))
L_com_starts <- mapply(rep, com_starts, c(1,2,2))
fit_L_com <- nls(L_com,
               data = full_bc_data_nb_adm,
               start = L_com_starts)
...
K_com <- bc_tl ~ Linf[ancestry_group]*(1-exp(-K*(annulus-t0[ancestry_group])))
K_com_starts <- mapply(rep, com_starts, c(2,1,2))
fit_K_com <- nls(K_com,
               data = full_bc_data_nb_adm,
               start = K_com_starts)

t_com <- bc_tl ~ Linf[ancestry_group]*(1-exp(-K[ancestry_group]*(annulus-t0)))
t_com_starts <-mapply(rep, com_starts, c(2,2,1))
fit_t_com <- nls(t_com,
               data = full_bc_data_nb_adm,
               start = t_com_starts)

K_L_com <- bc_tl ~ Linf*(1-exp(-K*(annulus-t0[ancestry_group])))
K_L_com_starts <- mapply(rep, com_starts, c(1,1,2))
fit_K_L_com <- nls(K_L_com,
               data = full_bc_data_nb_adm,
               start = K_L_com_starts)

K_t_com <- bc_tl ~ Linf[ancestry_group]*(1-exp(-K*(annulus-t0)))
K_t_com_starts <- mapply(rep, com_starts, c(2,1,1))
fit_K_t_com <- nls(K_t_com,
               data = full_bc_data_nb_adm,
               start = K_t_com_starts)

L_t_com <- bc_tl ~ Linf*(1-exp(-K[ancestry_group]*(annulus-t0)))
L_t_com_starts <- mapply(rep, com_starts, c(1,2,1))
fit_L_t_com <- nls(L_t_com,
               data = full_bc_data_nb_adm,
               start = L_t_com_starts)

anova(fit_com, fit_gen)

anova(fit_L_com, fit_gen)
anova(fit_K_com, fit_gen)
anova(fit_t_com, fit_gen)

anova(fit_K_t_com, fit_t_com)
anova(fit_L_t_com, fit_t_com)

anova(fit_t_com, fit_com)

AICc(fit_com, fit_gen, fit_K_com, fit_L_com, fit_t_com, fit_K_L_com, fit_K_t_com, fit_L_t_com)

library(MuMIn)

full_bc_data <- full_bc_data %>%
  mutate(size_index = bc_tl/annulus)

ggplot(full_bc_data, aes(x = size_index)) +
  geom_histogram()

ggplot(full_bc_data, aes(x = size_index, y = smb, color = ancestry_group)) +
  geom_point() + 
...
plot(bc_tl~jitter(annulus,0.3),data=full_bc_data,subset=river=="Big_Sugar",pch=19,xlab="Age (yrs)",
ylab="Total Length (mm)")
points(bc_tl~jitter(annulus,0.3),data=full_bc_data,subset=river=="Elk_River",pch=19,col="gray")
vbTypical <- vbFuns("typical")
curve(vbTypical(x,Linf=coef(fit_t_com)[-3]),from=1,to=10,lwd=2,add=TRUE)
curve(vbTypical(x,Linf=coef(fit_L_t_com)[-2]),from=1,to=10,col="gray",lwd=2,add=TRUE)
legend("topleft",legend=c("Big Sugar","Elk"),col=c("black","gray"),lwd=2,lty=1,cex=0.75)

vb_model <- function(annulus, Linf, K, t0) {
  bc_tl = Linf*(1-exp(-K*(annulus-t0)))
  return(bc_tl)
}

mod <- nlme(bc_tl ~ model(annulus, Linf, K, t0),
            fixed = list(Linf ~ 1, K ~ 1, t0 ~ 1), 
            random = t0 ~ 1 | river,
            data = full_bc_data_nb_adm,
            start = list(fixed = c(Linf = 381.2697, K = 0.4110884, t0 = -0.09600566)),
            method = "REML")
...
nlmer(bc_tl ~ vb_model(annulus, Linf, K, t0),
      fixed = list(Linf ~ 1, K ~ 1, t0 ~1),
      random = list(t0 ~ 1|river), 
      nAGQ = 0, 
      data = full_bc_data_nb_adm, 
      start = c(Linf = 381.2697, K = 0.4110884, t0 = -0.09600566), 
      verbose = T)
