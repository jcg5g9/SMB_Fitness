...
## Phases of Analysis
### Phase 1: Data preparation and linear back-calculation
...
## PHASE 1: DATA PREPARATION AND LINEAR BACK CALCULATION
In this phase of analysis, we load and prepare real total length (tl_alive) and consensus age data from the full ancestry dataset (Analysis 3).
...
# Filter dataset to keep only fish with total length and concensus age data ("sample"; NOT "reference")
