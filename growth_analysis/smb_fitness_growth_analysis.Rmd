...
full_bc_data$res <- resid(global)

ggplot(full_bc_data, aes(x = ancestry_group, y  = res)) +
...
ggplot() + 
  ...
  geom_hline(yintercept = 440.94667, linetype = "solid", size = 0.8) +
...
# Save full river predict file for downstream analysis
save(river_predict, file = "data/river_data/river_predict.Rda")
...
# Save full sex predict file for downstream analysis
save(sex_predict, file = "data/sex_data/sex_predict.Rda")
...
# Save full ancestry predict file for downstream analysis
save(ancestry_predict, file = "data/ancestry_data/ancestry_predict.Rda")
...
ggplot() + 
  ...
  geom_line(data = ancestry_predict, aes(x = annulus, y = fit, linetype = ancestry_group, color = ancestry_group), show.legend = F) +
  theme_set(theme_cowplot(12)) +
...
# Save full river predict file for downstream analysis
save(nb_adm_predict, file = "data/ancestry_data/nb_adm_predict.Rda")
...
```{r}
# Load in global predicted data 
load("data/global_data/global_predict.Rda")

# Load in river predicted data
load("data/river_data/river_predict.Rda")

# Load in sex predicted data 
load("data/sex_data/sex_predict.Rda")

# Load in ancestry predicted data 
load("data/ancestry_data/nb_adm_predict.Rda")
...
This group of figures is the basis of Figure 2 in the final manuscript.
