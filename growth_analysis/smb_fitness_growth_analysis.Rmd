...
f_bs_plot <- ggplot() + 
  geom_point(data = full_bc_data, aes(x = annulus, y = bc_tl, fill = smb), position = position_jitter(width = 0.3), show.legend = F, size = 3, pch = 21, alpha = 0.6) + 
  geom_ribbon(data = f_bs, aes(x = ages, ymin = lci, ymax = uci, color = ancestry, alpha = 0.01), fill = c("grey"), show.legend = F) +
  geom_line(data = f_bs, aes(x = ages, y = length, color = ancestry), size = 1, show.legend = F) +
  theme_set(theme_cowplot(12)) +
  scale_fill_gradient(high = "deeppink2", low = "deepskyblue") +
...
m_bs_plot <- ggplot() + 
  geom_point(data = full_bc_data, aes(x = annulus, y = bc_tl, fill = smb), position = position_jitter(width = 0.3), show.legend = F, size = 3, pch = 21, alpha = 0.6) + 
  geom_ribbon(data = m_bs, aes(x = ages, ymin = lci, ymax = uci, color = ancestry, alpha = 0.01), fill = c("grey"), show.legend = F) +
...
f_e_plot <- ggplot() + 
  geom_point(data = full_bc_data, aes(x = annulus, y = bc_tl, fill = smb), position = position_jitter(width = 0.3), show.legend = F, size = 3, pch = 21, alpha = 0.6) + 
  geom_ribbon(data = f_e, aes(x = ages, ymin = lci, ymax = uci, color = ancestry, alpha = 0.01), fill = c("grey"), show.legend = F) +
...
m_e_plot <- ggplot() + 
  geom_point(data = full_bc_data, aes(x = annulus, y = bc_tl, fill = smb), position = position_jitter(width = 0.3), show.legend = F, size = 3, pch = 21, alpha = 0.6) + 
  geom_ribbon(data = m_e, aes(x = ages, ymin = lci, ymax = uci, color = ancestry, alpha = 0.01), fill = c("grey"), show.legend = F) +
