...
### STEP 2: Calculate intra-observer error for each observer and average intra-observer error across observers; run the Rmd chunk below.
...
# rbind all recount data
oto_recounts <- rbind(eddie, joe, michael)

ggplot(oto_recounts, aes(x = age, y = recount)) +
  geom_point(position = position_jitter()) +
  geom_smooth(method = "lm")

summary(lm(age ~ recount, oto_recounts))
```
