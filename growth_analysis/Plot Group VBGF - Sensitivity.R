...
fit_group3 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_sen_fit_group3.rds")
...
fit_group7 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_sen_fit_group7.rds")
...
fit_group8 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_sen_fit_group8.rds")
