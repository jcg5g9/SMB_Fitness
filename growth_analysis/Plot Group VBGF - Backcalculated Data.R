...
fit_group3 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_fit_group3.rds")
...
fit_group5 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_fit_group5.rds")
...
# - No river/sex effects
fit_group6 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_fit_group6.rds")
