...
fit4 <- stan(
  file = "growth_analysis/Models/vbgf4_reparam.stan",  # Stan program
...
saveRDS(fit4, file = "growth_analysis/Models/Fits/vbgf_fit4_reparam.rds")
...
# * Print and plot MCMC ----
print(fit4, pars=c("mu_lmin", "mu_lmax", "mu_k","beta_lmin", "beta_lmax", "beta_k", "linf_lineage", "k_lineage", "t0_lineage"), probs=c(.1,.5,.9)) # None of the betas are sig
traceplot(fit4, pars = c("mu_lmin", "mu_lmax", "mu_k", "sigma"), inc_warmup = FALSE, nrow = 2)
traceplot(fit4, pars = c("beta_lmin", "beta_lmax", "beta_k"), inc_warmup = FALSE, nrow = 2)
