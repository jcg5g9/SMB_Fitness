...
traceplot(fit3, pars = c("mu_linf", "mu_k", "mu_t0", "sigma"), inc_warmup = FALSE, nrow = 2)
traceplot(fit3, pars = c("beta_linf", "beta_k", "beta_t0"), inc_warmup = FALSE, nrow = 2)
traceplot(fit3, pars = c("Lcorr_group", "sigma_group"), inc_warmup = FALSE, nrow = 2)

# -- Look at pairs
pairs(fit3, pars = c("mu_linf", "mu_k", "mu_t0"), las = 1)
pairs(fit3, pars = c("beta_linf", "beta_k", "beta_t0"), las = 1)
pairs(fit3, pars = c("Lcorr_group", "sigma_group"), las = 1)
