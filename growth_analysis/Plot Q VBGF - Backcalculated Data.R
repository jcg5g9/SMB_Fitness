...
fit1 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_fit1.rds")
...
fit2 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_fit2.rds")
...
fit3 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_fit3.rds")
...
fit5 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_fit5.rds")
...
# - No river/sex effects
fit6 <- readRDS(file = "growth_analysis/Models/Fits/vbgf_fit6.rds")
