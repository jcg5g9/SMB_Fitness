...
clumppExport(align, 
            parammode = 3, 
            paramrep = 10000,
            exportpath = "../data/structure_data/clumpp_data/clumpp")
```
...
##### deltak results for SPB and SMBC populations: `deltaK.pdf` 
```{r}
# DeltaK results
...
k2 <- readQ("../data/structure_data/clumpp_data/clumpp/pop_K2/pop_K2-combined-merged.txt")
