...
This plot is the basis for Figure S2 in the final manuscript.
...
#### 4a. Read in genotype data and convert to genind object for DFA:
```{r}
...
# Create vector of ancestry groups to be used as "populations" in DAPC
...
pdf("figures/dapc.pdf", width = 8, height = 6)
